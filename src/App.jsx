    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <button className="bg-rose-600 text-white px-6 py-2 rounded-full hover:bg-rose-700 transition">Book Now</button>
            </div>
          </div>
        </div>
      </nav>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <h2 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight">Your Love Story, <span className="text-rose-600">Perfectly Planned</span></h2>
                <p className="text-xl text-gray-600">Turn your dream wedding into reality with Wedfinity</p>
              </div>
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="bg-rose-600 text-white px-8 py-4 rounded-full font-semibold hover:bg-rose-700 transition">Start Planning</button>
                <button className="border-2 border-rose-600 text-rose-600 px-8 py-4 rounded-full font-semibold hover:bg-rose-50 transition">View Gallery</button>
              </div>
      ...
      <section id="services" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-gradient-to-br from-rose-50 to-pink-50 p-8 rounded-2xl hover:shadow-xl transition transform hover:translate-y-[-8px]">
              <div className="text-5xl mb-4">💍</div>
              <h4 className="text-xl font-semibold text-gray-900 mb-3">Ceremony Planning</h4>
              <p className="text-gray-600">Create a magical ceremony tailored to your story</p>
            </div>
            <div className="bg-gradient-to-br from-rose-50 to-pink-50 p-8 rounded-2xl hover:shadow-xl transition transform hover:translate-y-[-8px]">
              <div className="text-5xl mb-4">🍾</div>
              <h4 className="text-xl font-semibold text-gray-900 mb-3">Reception Design</h4>
              <p className="text-gray-600">Elegant venues and décor that reflect your vision</p>
            </div>
            <div className="bg-gradient-to-br from-rose-50 to-pink-50 p-8 rounded-2xl hover:shadow-xl transition transform hover:translate-y-[-8px]">
              <div className="text-5xl mb-4">📸</div>
              <h4 className="text-xl font-semibold text-gray-900 mb-3">Vendor Network</h4>
              <p className="text-gray-600">Connected with the best photographers and caterers</p>
            </div>
            <div className="bg-gradient-to-br from-rose-50 to-pink-50 p-8 rounded-2xl hover:shadow-xl transition transform hover:translate-y-[-8px]">
              <div className="text-5xl mb-4">🎨</div>
              <h4 className="text-xl font-semibold text-gray-900 mb-3">Custom Styling</h4>
              <p className="text-gray-600">Personalized themes and color palettes</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-700 mb-6">"Wedfinity made our wedding day absolutely perfect!"</p>
              <p className="font-semibold text-gray-900">Sarah & James</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <div className="flex gap-1 mb-4">⭐⭐⭐⭐⭐</div>
              <p className="text-gray-700 mb-6">"Professional, creative, and so attentive to every detail."</p>
              <p className="font-semibold text-gray-900">Emma & Michael</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <div className="flex gap-1 mb-4">⭐⭐⭐⭐⭐</div>
              <p className="text-gray-700 mb-6">"From start to finish, everything was effortless."</p>
      ...
      <section id="gallery" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Explore our portfolio</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group relative overflow-hidden rounded-2xl shadow-lg h-64 bg-gradient-to-br from-rose-300 to-pink-400 flex items-center justify-center cursor-pointer">
      ...
      <section className="py-20 bg-gradient-to-r from-rose-600 to-pink-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button className="bg-white text-rose-600 px-10 py-4 rounded-full font-bold text-lg hover:bg-rose-50 transition">Schedule Consultation</button>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-rose-400">Planning</a></li>
                <li><a href="#" className="hover:text-rose-400">Coordination</a></li>
                <li><a href="#" className="hover:text-rose-400">Vendors</a></li>
              </ul>
            </div>
            <div>
              <h5 className="font-semibold mb-4">Company</h5>
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-rose-400">About</a></li>
